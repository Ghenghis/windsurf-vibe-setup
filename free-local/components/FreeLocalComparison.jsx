...
export default function FreeLocalComparison() {
  ...
  const tools = [
    // LLM Runtime
    {
      ...
      quality: 95,
      ease: 90,
      note: 'Run 70B+ models locally with your GPU',
    },
    {
      category: 'llm',
      name: 'LM Studio',
      ...
      quality: 95,
      ease: 95,
      note: 'Beautiful GUI, supports GGUF models',
    },
    {
      category: 'llm',
      name: 'vLLM',
    ...
    },
    {
      ...
      free: true,
      local: true,
      paidAlt: 'Pinecone Pro',
      savings: '$200+/mo',
      quality: 98,
      ease: 70,
      note: 'Billion-scale vectors',
    },
    {
      category: 'vector',
      name: 'Qdrant',
      free: true,
      local: true,
      paidAlt: 'Weaviate Cloud',
      savings: '$100+/mo',
      quality: 95,
      ease: 80,
      note: 'Rust-based, fast',
    },
    {
      category: 'vector',
      name: 'LanceDB',
    ...
    // Web Search
    {
      ...
      free: true,
      local: true,
      paidAlt: 'Perplexity API',
      savings: '$20/mo',
      quality: 90,
      ease: 75,
      note: 'Privacy-first, self-hosted',
    },
    {
      category: 'search',
      name: 'DuckDuckGo MCP',
    ...
    // Code Assistant
    {
      ...
      free: true,
      local: true,
      paidAlt: 'GitHub Copilot',
      savings: '$10/mo',
      quality: 90,
      ease: 95,
      note: 'Uses your local LLM',
    },
    {
      category: 'code',
  ...
  const totalSavings = tools.reduce(
    (acc, t) => acc + parseInt(t.savings.replace(/[^0-9]/g, '')),
    0
  );
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-purple-200 text-lg">
            Everything you need for AI development — without paid subscriptions
          </p>
        ...
        <div className="grid gap-4">
          {filtered.map((tool, idx) => (
            <div
              key={idx}
              className="bg-slate-800/50 backdrop-blur border border-slate-700 rounded-xl p-4 hover:border-purple-500/50 transition-all"
            >
        ...
        <div className="mt-8 bg-slate-800/50 border border-slate-700 rounded-xl p-6">
          ...
          <div className="font-mono text-sm space-y-2">
            <div className="bg-slate-900 rounded p-3 text-green-400">
              <span className="text-slate-500"># Install Ollama</span>
              <br />
              winget install Ollama.Ollama
            </div>
            <div className="bg-slate-900 rounded p-3 text-green-400">
              <span className="text-slate-500"># Pull your first model</span>
              <br />
            ...
            <div className="bg-slate-900 rounded p-3 text-green-400">
              ...
              <br />
              ollama run qwen2.5-coder:32b "Create a React component"
            </div>
          </div>
        </div>
      </div>
