...
const { AGENT_REGISTRY, AGENT_COUNT, getAgentsByCategory, getAllAgents } = require('./ai-agents/agent-registry');
...
const multiAgentTools = {
  ...
  list_all_agents: {
    ...
    inputSchema: {
      ...
      properties: {
        category: {
          type: 'string',
          description: 'Filter by category (architecture, coding, testing, security, devops, documentation, data, performance, quality, orchestration)',
          enum: ['all', 'architecture', 'coding', 'testing', 'security', 'devops', 'documentation', 'data', 'performance', 'quality', 'orchestration']
        },
        format: {
          type: 'string',
  ...
  run_agent_task: {
    name: 'run_agent_task',
    description: 'Execute a task using the multi-agent system. Automatically selects and coordinates appropriate agents.',
    inputSchema: {
      type: 'object',
      properties: {
        description: {
        ...
        type: {
          ...
          enum: ['create-project', 'code-generation', 'testing', 'deployment', 'security-audit', 'documentation', 'performance', 'code-review', 'ml-pipeline', 'full-stack']
        },
        keywords: {
          type: 'array',
          items: { type: 'string' },
          description: 'Keywords to help route to appropriate agents (e.g., ["react", "typescript", "api"])'
        }
      },
