...
const { harness, startHarness, stopHarness, getHarnessStatus, toggleHarness } = require('./controller');
...
function setupEventListeners() {
  ...
  harness.on('codingSessionComplete', (data) => {
    console.log(`🤖 Session ${data.session} complete: ${data.feature} (${data.success ? '✅' : '❌'})`);
  });
